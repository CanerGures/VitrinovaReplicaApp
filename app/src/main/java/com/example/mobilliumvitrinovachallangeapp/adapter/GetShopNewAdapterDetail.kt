...
class GetShopNewAdapterDetail(private val shopNew: List<ShopX>) :
    RecyclerView.Adapter<GetShopNewAdapterDetail.GetShopNewDetailViewHolder>() {
    inner class GetShopNewDetailViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val shopDetailParent: CardView = itemView.findViewById(R.id.shopNewParent)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GetShopNewDetailViewHolder {
        val itemView =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.shops_new_content_detail, parent, false)
        return GetShopNewDetailViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: GetShopNewDetailViewHolder, position: Int) {
        ...
        try {
            ...
            holder.textProductCount.text = holder.itemView.context.getString(
                R.string.shop_new_product_count,
